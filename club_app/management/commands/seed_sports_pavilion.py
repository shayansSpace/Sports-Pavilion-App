...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 12', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 13', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 14', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 15', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 16', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 17', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 18', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 19', defaults={'unit_status': 'Maintenance'})
        PlayUnit.objects.get_or_create(facility=f6, unit_num='Game Station 20', defaults={'unit_status': 'Maintenance'})
